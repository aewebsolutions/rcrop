;(function(d){d.rcrop={settings:{full:!1,minSize:[20,20],maxSize:[null,null],preserveAspectRatio:!1,inputs:!0,inputsPrefix:"",grid:!1,preview:{display:!1,size:[50,50],wrapper:""}}};var m=ResponsiveCrop=function(e,k){var a=this;this.el=e instanceof d?e:d(e);this.image={width:0,height:0};this.wrapper=d("<div>",{"class":"rcrop-wrapper"});this.cropArea=d("<div>",{"class":"rcrop-croparea"});this.cropData={width:0,height:0,x:0,y:0};this.outer={wrapper:d("<div>",{"class":"rcrop-outer-wrapper"}),left:d("<div>",
{"class":"rcrop-outer rcrop-outer-left"}),right:d("<div>",{"class":"rcrop-outer rcrop-outer-right"}),top:d("<div>",{"class":"rcrop-outer rcrop-outer-top"}),bottom:d("<div>",{"class":"rcrop-outer rcrop-outer-bottom"})};this.cropAspectRatio;this.preview=null;this.clayfy;this.settings=d.extend(!0,{},d.rcrop.settings,k);var u=function(){a.wrapper.insertAfter(a.el);a.wrapper.append(a.el);a.wrapper.append(a.outer.wrapper);a.outer.wrapper.append(a.outer.left,a.outer.right,a.outer.top,a.outer.bottom);a.wrapper.append(a.cropArea);
a.cropArea.append('<div class="rcrop-croparea-inner">');a.settings.grid&&a.cropArea.append('<div class="rcrop-grid"><div class="rcrop-grid-line"></div><div class="rcrop-grid-line"></div></div>');m();if(a.settings.inputs){var b=0!=a.settings.inputsPrefix?a.settings.inputsPrefix+"-":"";d.each(["x","y","width","height"],function(c,f){a.wrapper.append('<input type="hidden" name="'+b+f+'[]">')})}},m=function(){var b=d('<div class="rcrop-handler-wrapper"></div>');d.each(["top-left","top-right","bottom-left",
"bottom-right"],function(a,f){b.append('<div class="rcrop-handler-'+f+' rcrop-handler-corner""></div>')});d.each(["top","right","bottom","left"],function(a,f){b.append('<div class="rcrop-handler-'+f+' rcrop-handler-border"></div>')});a.cropArea.append(b)},p=function(){a.cropData=n({width:a.clayfy.newSize.width,height:a.clayfy.newSize.height,y:a.clayfy.newSize.top,x:a.clayfy.newSize.left},a.image.width/a.el.width());a.cropData.width=Math.max(a.cropData.width,a.settings.minSize[0]);a.cropData.height=
Math.max(a.cropData.height,a.settings.minSize[1]);a.settings.maxSize[0]&&(a.cropData.width=Math.min(a.cropData.width,a.settings.maxSize[0]));a.settings.maxSize[1]&&(a.cropData.height=Math.min(a.cropData.height,a.settings.maxSize[1]));if(a.settings.preserveAspectRatio){var b=a.settings.minSize[0];a.cropData.height*a.cropAspectRatio>(a.settings.maxSize[0]||a.image.width)||a.cropData.height*a.cropAspectRatio<b?a.cropData.height=Math.round(a.cropData.width/a.cropAspectRatio):a.cropData.width=Math.round(a.cropData.height*
a.cropAspectRatio)}a.cropData.y+a.cropData.height>a.image.height&&(a.cropData.y=a.image.height-a.cropData.height);a.cropData.x+a.cropData.width>a.image.width&&(a.cropData.x=a.image.width-a.cropData.width);a.settings.inputs&&d.each(["x","y","width","height"],function(b,f){a.wrapper.find('[name$="'+f+'[]"]').val(a.cropData[f])});a.settings.preview.display&&l()},q=function(){var b=a.el[0].getBoundingClientRect(),c=b.width,b=b.height,f=a.clayfy.newSize,d=f.width,e=f.height,g=f.top,f=f.left;a.cropArea.css({width:d/
c*100+"%",height:e/b*100+"%",top:g/b*100+"%",left:f/c*100+"%"});a.outer.left.width(f/c*100+"%");a.outer.top.height(g/b*100+"%");a.outer.bottom.css({top:(g+e)/b*100+"%"});a.outer.right.css({left:(f+d)/c*100+"%"})},t=function(){var b=a.clayfy.newSize;a.outer.left.width(b.left);a.outer.top.height(b.top);a.outer.bottom.css({top:b.top+b.outerHeight});a.outer.right.css({left:b.left+b.outerWidth})},v=function(){var b=a.settings,c=a.clayfy.settings;c.minSize=g(b.minSize);c.maxSize=g(b.maxSize);a.clayfy.draggable.setBounderies()},
w=function(){var b=a.settings;a.cropArea.clayfy({type:"resizable",container:a.wrapper,preserveAspectRatio:b.preserveAspectRatio,minSize:g(b.minSize),maxSize:g(b.maxSize)});a.clayfy=a.cropArea.clayfy("instance");a.clayfy.originalSize.width=a.settings.minSize[0];a.clayfy.originalSize.height=a.settings.minSize[1];a.resize(b.full?a.image.width:Math.max(.8*a.image.width,b.minSize[0]),b.full?a.image.height:Math.max(.8*a.image.height,b.minSize[1]),"center","center");a.cropArea.on("mousedown touchstart",
v);a.cropArea.on("clayfy-resizeend clayfy-drop",p);a.cropArea.on("clayfy-resize clayfy-drag",t);a.settings.preview.display&&(a.cropArea.on("clayfy-resize clayfy-drag",l),a.cropArea.on("clayfy-cancel",l));a.cropArea.on("clayfy-resizeend clayfy-drop",q);a.cropArea.on("clayfy-cancel",q);a.cropArea.on("clayfy-resizeend clayfy-drop",function(){a.el.trigger("rcrop-changed",[a])});a.cropArea.on("clayfy-drag clayfy-resize",function(){a.el.trigger("rcrop-change",[a])})},r=function(){var b=a.settings.preview.size,
c=[],d=a.clayfy?a.clayfy.newSize:{width:a.cropArea.width(),height:a.cropArea.height()};"string"===typeof b[0]&&-1<b[0].indexOf("%")?c[0]=Number(b[0].replace("%",""))/100*d.width:c[0]=b[0];"string"===typeof b[1]&&-1<b[1].indexOf("%")?c[1]=Number(b[1].replace("%",""))/100*d.height:c[1]=b[1];return c},x=function(){var b=a.settings.preview.wrapper;b&&(b=b instanceof d?b:d(b));b&&b.length||(b=d("<div>",{"class":"rcrop-preview-wrapper"}),a.wrapper.after(b));var c=r();a.preview=d('<canvas width="'+c[0]+
'" height="'+c[1]+'"></canvas>');a.preview.appendTo(b)},l=function(b){var c=a.cropData;b&&(c=n({width:a.clayfy.newSize.width,height:a.clayfy.newSize.height,x:a.clayfy.newSize.left,y:a.clayfy.newSize.top},a.image.width/a.el.width()));b=r();a.preview.attr({width:b[0],height:b[1]});a.preview[0].getContext("2d").drawImage(a.el[0],c.x,c.y,c.width,c.height,0,0,b[0],b[1])},n=function(a,c){if("object"===typeof a){var d=a instanceof Array?[]:{},e;for(e in a)d[e]="number"!=typeof a[e]?null:Math.round(a[e]*
c);return d}return a*c},g=function(b){return n(b,a.el.width()/a.image.width)};this.getValues=function(){p();return{width:a.cropData.width,height:a.cropData.height,y:a.cropData.y,x:a.cropData.x}};this.getRealSize=function(b){var c=new Image;c.onload=function(){a.image.width=this.width;a.image.height=this.height;"function"===typeof b&&b();return{width:a.image.width,height:a.image.height}};c.onerror=function(){return{width:null,height:null}};c.src=a.el.attr("src")};this.getDataURL=function(b,c){b=b||
a.cropData.width;c=c||a.cropData.height;r();var f=d('<canvas width="'+b+'" height="'+c+'"></canvas>');f[0].getContext("2d").drawImage(a.el[0],a.cropData.x,a.cropData.y,a.cropData.width,a.cropData.height,0,0,b,c);return f[0].toDataURL()};this.resize=function(b,c,d,e){var h=a.settings;b=h.maxSize[0]?Math.min(b,a.image.width,h.maxSize[0]):Math.min(b,a.image.width);c=h.maxSize[1]?Math.min(c,a.image.height,h.maxSize[1]):Math.min(c,a.image.height);b=h.minSize[0]?Math.max(b,h.minSize[0]):b;c=h.minSize[1]?
Math.max(c,h.minSize[1]):c;b=g(b);c=g(c);h.preserveAspectRatio&&(b/c>a.cropAspectRatio?b=c*a.cropAspectRatio:c=b/a.cropAspectRatio);e="undefined"===typeof e?a.cropArea.position().top:"center"===e?(a.el.height()-c)/2:g(e);d="undefined"===typeof d?a.cropArea.position().left:"center"===d?(a.el.width()-b)/2:g(d);d+b>a.el.width()&&(d=a.el.width()-b);e+c>a.el.height()&&(e=a.el.height()-c);a.cropArea.css({width:b,height:c,top:e,left:d});a.clayfy.newSize=a.clayfy.getNewSize();p();t();q();a.settings.preview.display&&
l()};this.destroy=function(){var b=a.el;a.wrapper.replaceWith(b);b.attr("style","")};(function(){a.cropAspectRatio=a.settings.minSize[0]/a.settings.minSize[1];u();a.settings.preview.display&&x();a.getRealSize(function(){w();a.el.trigger("rcrop-ready")})})()};d.fn.rcrop=function(e){var k=arguments;if(void 0===e||"object"===typeof e)return this.each(function(){d.data(this,"rcrop")||d.data(this,"rcrop",new m(this,e))});if("string"===typeof e&&"_"!==e[0]&&"init"!==e){if("instance"===e)return this.length?
d.data(this[0],"rcrop"):null;if(-1!=d.inArray(e,d.fn.rcrop.getters)){var a=d.data(this[0],"rcrop");return a[e].apply(a,Array.prototype.slice.call(k,1))}return this.each(function(){var a=d.data(this,"rcrop");a instanceof m&&"function"===typeof a[e]&&a[e].apply(a,Array.prototype.slice.call(k,1))})}};d.fn.rcrop.getters=["getDataURL","getValues","getRealSize"]})(jQuery);
